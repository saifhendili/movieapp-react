...
class Form extends Component {
    ...
    render() {
        return (
            <div>
                <img src={Add} className="imgform" width ="150px"onClick={this.handleOpen}/>
                <Modal
                    style={customStyles}
                ...
                >
                    ...
                    >
                        ...
                        <input type="text" name="name" onChange={this.handleChange} style={{margin:'15px',padding:'13px 40px',borderRadius:'5px'}} />
                      
                        <label style={{margin:'15px'}}>Rating</label>
                        <input type="text" name="rating"value={this.state.rating}onChange={this.handleChangeRating} maxLength={1} style={{margin:'15px',padding:'13px 40px',borderRadius:'5px'}} />
                        <label style={{margin:'15px'}}>Link</label>
                        <input type="text" name="lien" onChange={this.handleChange}style={{margin:'15px',padding:'13px 40px',borderRadius:'5px'}} />
                        <button onClick={this.onSubmit} style={{margin :'25px 50px',padding:'15px 35px',borderRadius:'5px'}}>Submit</button>
